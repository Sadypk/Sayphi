...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    _buildCards() {
      return Column(
        children: [
          SizedBox(
              height: Get.height * .5,
              child: HomeViewModel.matchedUserList.length > 0
                  ? RotatedBox(
                      quarterTurns: 2,
                      child: TCard(
                        controller: _controller,
                        cards: HomeViewModel.matchedUserList
                            .map((matchedUser) =>
                                UserSwiperCard(matchedUser: matchedUser))
                            .toList(),
          ...
          if (HomeViewModel.matchedUserList.length > 0)
            Padding(
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            HomeViewModel
                                .matchedUserList[_controller.index].name,
                            style: TextStyle(
                              fontSize: 22,
                          ...
                          Text(
                            HomeViewModel
                                .matchedUserList[_controller.index].address,
                            style: TextStyle(
    ...
    /// users bluh
    _buildUserBluh() {
      return HomeViewModel.matchedUserList.length > 0
          ? Padding(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: 18, fontFamily: CFontFamily.REGULAR),
                    ),
                  ),
                  Positioned(
                    top: 0,
...
class UserSwiperCard extends StatelessWidget {
  ...
  const UserSwiperCard({Key? key, required this.matchedUser}) : super(key: key);
            ...
            child: Row(
              ...
              children: [
                ...
                CIconButton(
                    onTap: () {
                      Get.to(
                          () => SuperLikeOptionScreen(userId: matchedUser.id));
                    },
